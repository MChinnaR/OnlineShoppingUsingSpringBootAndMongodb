...
public class UserController {
	...
	public ModelAndView showWelcomePage(ModelMap model, @RequestParam String email, @RequestParam String password) {
	...
	public ModelAndView addToCart(ModelMap model, @RequestParam String item) {
		System.out.println("true in cart-----------------@@@@@@@@@@@@@    "+item);
		if (userService.addToCart(item)) {
	...
	public ModelAndView cart() {
		...
		LinkedHashMap<String, Integer> items=userService.mainCart();
		LinkedHashMap<String, Integer> message=items;
